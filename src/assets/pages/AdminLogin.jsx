      ...
      <main className="flex-1 overflow-hidden px-10 pb-6 max-w-[1800px] w-full mx-auto grid grid-cols-12 gap-8">
        ...
        <div className="col-span-12 lg:col-span-9 h-full overflow-y-auto custom-scroll pr-4 pb-10">
          {displayPhotos.length > 0 ? (
            ...
            <div className="min-h-[55vh] flex flex-col items-center justify-center border-4 border-dashed border-gray-100 dark:border-gray-800 rounded-[4rem] text-center p-10">
                <div className="w-20 h-20 bg-gray-50 dark:bg-gray-900 rounded-full flex items-center justify-center mb-6">
                  <Search size={32} className="text-gray-200" />
                </div>
                <h3 className="text-2xl font-black text-gray-300 uppercase italic">
                  {allPhotos.length === 0 ? "No Photos Yet" : "No Matches Found"}
                </h3>
                <p className="text-gray-400 text-xs mt-2 max-w-[220px] font-medium leading-relaxed">
                  {allPhotos.length === 0
                    ? "Once the organiser uploads photos to this event, they'll show up here."
                    : "Try another folder from the left."}
                </p>
            </div>
          )}
        </div>
